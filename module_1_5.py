...
# 2
immutable_var = ('str', 22, 45.6, True)
print(immutable_var)

# 3
# print(immutable_var.append('str1'))
# Кортеж является неизменяемым объектом, поэтому
# элементы кортежа изменить нельзя

# 4
mutable_list = ['str', 22, 45.6, True]
mutable_list.insert(1, 'str1')
print(mutable_list)
