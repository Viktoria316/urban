...
они отправляются от одного и того же пользователя(администрации
...
Если строки recipient и sender не содержит "@" или не
оканчивается на ".com"/".ru"/".net", то вывести на экран(в консоль)
...
# Посоветуйте как строчки 61-62 сократить по максимуму а, пожалуйста